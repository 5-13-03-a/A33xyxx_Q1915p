// js/chat-detail-ui.js · 聊天详情页 HTML 模板（照抄原版聊天室结构）
    ...
    '<style>' +
        ...
        /* ===== 交互反馈 ===== */
        '.chat-app-window .ca-hdr-btn:active{transform:scale(.84);}' +
        '.chat-app-window .ca-nav-item:active{transform:scale(.88);}' +
        '.chat-app-window .ca-compose-btn:active{transform:scale(.86);}' +
        '.chat-app-window .ca-contact-act-btn:active{transform:scale(.85);}' +
        '.chat-app-window .ca-pinned-item:active{transform:scale(.88);}' +
        '.chat-app-window .ca-pinned-inner{position:relative;z-index:2;}' +
        '.chat-app-window .ca-pinned-ring.has-story::before{z-index:1;}' +
        '.chat-app-window .ca-tab:active{transform:scale(.92);}' +
        '.chat-app-window .ca-disc-card:active{transform:scale(.96);}' +
        '.chat-app-window .ca-discover-banner:active{transform:scale(.98);}' +
        '.chat-app-window .ca-dossier-btn:active{transform:scale(.95);}' +
        '#caChatDetail .nav-btn:active{transform:scale(0.82);}' +
        '#caChatDetail .gradient-avatar:active{transform:scale(0.9);}' +
        '#caChatDetail .icon-btn:active{transform:scale(0.85);}' +
        '#caChatDetail .send-btn:active{transform:scale(0.85);}' +
        '#caChatDetail .set-big-av:active{transform:scale(0.95);}' +
        '#caChatDetail .tool-item:active .tool-box{transform:scale(0.9);}' +
        '#caChatDetail .style-item-wrap:active .style-circle{transform:scale(0.9);}' +
        '#caChatDetail .api-fav:active{transform:scale(0.9);}' +
        '#caChatDetail .api-btn:active{transform:scale(0.96);}' +
        '#caChatDetail .set-savebtn:active{transform:scale(.95);}' +
    '</style>' +
        ...
        '<nav class="menu-overlay" id="cdMenuOverlay">' +
            ...
            '<ul class="menu-list">' +
                    ...
                    '<div class="accordion-content">' +
                        '<div class="accordion-inner">' +
                            '<div class="settings-panel">' +
                                ...
                                '</div>' +
                                '<div class="mini-divider" style="margin-top:16px;"></div>' +
                                '<div class="trans-mini-title" style="margin-top:14px;">Decorations / 装饰元素</div>' +
                                '<div class="ca-capsule-group" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">' +
                                    '<span style="font-size:10px;font-weight:600;color:#151515;">Corset Ribbon</span>' +
                                    '<div class="ca-capsules" id="cdDecCorsetCap">' +
                                        '<div class="ca-cap-item" data-val="on">Show</div>' +
                                        '<div class="ca-cap-item" data-val="off">Hide</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div class="ca-capsule-group" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">' +
                                    '<span style="font-size:10px;font-weight:600;color:#151515;">Axis Line</span>' +
                                    '<div class="ca-capsules" id="cdDecAxisCap">' +
                                        '<div class="ca-cap-item" data-val="on">Show</div>' +
                                        '<div class="ca-cap-item" data-val="off">Hide</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div class="mini-divider" style="margin-top:16px;"></div>' +
                                '<div class="trans-mini-title" style="margin-top:14px;">Meet Invite / 见面邀请</div>' +
                                '<div class="ca-capsule-group" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">' +
                                    '<span style="font-size:10px;font-weight:600;color:#151515;">允许对方邀请见面</span>' +
                                    '<div class="ca-capsules" id="cdInviteMeetCap">' +
                                        '<div class="ca-cap-item" data-val="on">Allow</div>' +
                                        '<div class="ca-cap-item" data-val="off">Off</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div class="mini-divider" style="margin-top:16px;"></div>' +
                ...
                '<li class="menu-item-wrapper" id="cdMenuCssWrapper">' +
                    ...
                    '</div>' +
                '</li>' +
                '<li><a class="menu-label" id="cdMenuPrivateSpace"><span class="menu-num">05</span>Private Space <span class="menu-cn">/. 私人空间</span></a></li>' +
                '<li><a class="menu-label" id="cdMenuDelete"><span class="menu-num">06</span>Delete Entity <span class="menu-cn">/. 删除</span></a></li>' +
            '</ul>' +
        '</nav>' +
        ...
        '<div class="bottom-zone">' +
            '<footer class="input-bar" id="cdInputBar">' +
                '<div class="icon-btn" id="cdAddBtn">' +
                    ...
                    '</svg>' +
                '</div>' +
                '<input type="text" id="cdUserInput" placeholder="Type a message..." autocomplete="off" enterkeyhint="send">' +
            ...
            '<div class="multi-bar" id="cdMultiBar">' +
                ...
                '<div class="ms-delete" id="cdMsDelete">' +
                ...
                '<div class="drawer-scroll" id="cdDrawerScroll">' +
                    ...
                    '<div class="drawer-top">' +
                        ...
                        '<div class="menu-grid">' +
                            ...
                            '<div class="menu-item" id="cdMenuImage">' +
                                '<div class="menu-btn">' +
                                    '<svg viewBox="0 0 24 24" fill="none" stroke="#151515" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">' +
                            ...
                            '<div class="folder-wrapper" id="cdFolderWrapper">' +
                                ...
                                '<div class="tools-inner">' +
                                    '<div class="tool-item" id="cdToolApi">' +
                                        '<div class="tool-box" style="width:48.5px;height:48.5px;border-radius:12px;background:#fff;border:1.5px solid #151515;display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden;">' +
                                            '<div style="position:absolute;inset:3.5px;border-radius:8.5px;border:0.5px solid rgba(21,21,21,.12);"></div>' +
                                            '<div style="position:absolute;inset:0;background-image:radial-gradient(circle,rgba(21,21,21,.07) 1px,transparent 1px);background-size:5px 5px;-webkit-mask-image:linear-gradient(to right,rgba(0,0,0,.5) 0%,transparent 70%);mask-image:linear-gradient(to right,rgba(0,0,0,.5) 0%,transparent 70%);"></div>' +
                                            '<div style="position:absolute;top:3.5px;left:-2px;background:#151515;color:#fff;font-family:\'Share Tech Mono\',monospace;font-size:4.5px;font-weight:800;padding:1.5px 5px 1.5px 4px;clip-path:polygon(0 0,100% 0,90% 50%,100% 100%,0 100%);letter-spacing:.8px;">Api</div>' +
                                            '<svg viewBox="0 0 24 24" width="14.5" height="14.5" fill="none" stroke="#A63426" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M17 2.1l4 4-4 4"/><path d="M3 12.2v-2a4 4 0 0 1 4-4h13.8"/><path d="M7 21.9l-4-4 4-4"/><path d="M21 11.8v2a4 4 0 0 1-4 4H3.2"/></svg>' +
                                        '</div>' +
                                        '<span style="color:#A63426;font-size:9px;font-weight:700;">Switch API</span>' +
                                    '</div>' +
                                    '<div class="tool-item" id="cdToolPrivateSpace">' +
                                        '<div class="tool-box" style="width:48.5px;height:48.5px;border-radius:12px;background:#fff;border:1.5px solid #151515;display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden;">' +
                                            '<div style="position:absolute;inset:3.5px;border-radius:8.5px;border:0.5px solid rgba(124,92,252,.12);"></div>' +
                                            '<div style="position:absolute;inset:0;background-image:radial-gradient(circle,rgba(124,92,252,.06) 1px,transparent 1px);background-size:5px 5px;-webkit-mask-image:linear-gradient(to right,rgba(0,0,0,.5) 0%,transparent 70%);mask-image:linear-gradient(to right,rgba(0,0,0,.5) 0%,transparent 70%);"></div>' +
                                            '<div style="position:absolute;top:3.5px;left:-2px;background:#151515;color:#fff;font-family:\'Share Tech Mono\',monospace;font-size:4.5px;font-weight:800;padding:1.5px 5px 1.5px 4px;clip-path:polygon(0 0,100% 0,90% 50%,100% 100%,0 100%);letter-spacing:.5px;">Room</div>' +
                                            '<svg viewBox="0 0 48 48" width="16.5" height="16.5" fill="none"><circle cx="36" cy="12" r="6" fill="#7c5cfc" opacity=".15"/><path d="M36 6a6 6 0 0 0 0 12 8 8 0 0 1 0-12z" fill="#7c5cfc" opacity=".3"/><path d="M6 38h36" stroke="#2a2830" stroke-width="1.2" stroke-linecap="round" opacity=".3"/><circle cx="20" cy="26" r="3.5" fill="#2a2830"/><path d="M20 30v5l-2 3M20 35l2 3" stroke="#2a2830" stroke-width="1.5" stroke-linecap="round"/><circle cx="28" cy="26" r="3.5" fill="#7c5cfc"/><path d="M28 30v5l-2 3M28 35l2 3" stroke="#7c5cfc" stroke-width="1.5" stroke-linecap="round"/><path d="M20 32h8" stroke="#2a2830" stroke-width="1.8" stroke-linecap="round"/><circle cx="24" cy="32" r="1.5" fill="#7c5cfc" opacity=".5"/><circle cx="12" cy="10" r="1" fill="#2a2830" opacity=".4"/><circle cx="18" cy="8" r=".8" fill="#7c5cfc" opacity=".5"/></svg>' +
                                        '</div>' +
                                        '<span style="font-family:\'DecoFont\',serif;color:#7c5cfc;font-size:9px;font-weight:700;letter-spacing:.5px;">Meet</span>' +
                                    '</div>' +
    ...
    '<style>' +
        ...
        '}' +
        '#caChatDetail #cdChatArea.swipe-returning {' +
        ...
        /* 遮罩 — 轻量化：纯色半透明，无 blur 避免卡顿 */
        '#caChatDetail .lp-overlay { position: absolute; inset: 0; background: rgba(245,243,240,0.55); z-index: 30; opacity: 0; pointer-events: none !important; transition: opacity 0.2s ease; will-change: opacity; }' +
        ...
        /* 确保高亮的消息行浮在最上层 */
        '#caChatDetail .msg-row.highlighted { z-index: 100 !important; position: relative !important; opacity: 1 !important; }' +
        '#caChatDetail .msg-row.highlighted .bubble { z-index: 101 !important; }' +
        ...
        '#caChatDetail.dec-corset-off .ca-corset-line { display: none !important; }' +
        '#caChatDetail .cd-axis-line { position: absolute; top: 0; bottom: 0; left: 38px; width: 1px; background: repeating-linear-gradient(to bottom, rgba(21,21,21,0.1) 0px, rgba(21,21,21,0.1) 4px, transparent 4px, transparent 12px); pointer-events: none; z-index: 0; display: none; }' +
        '#caChatDetail.dec-axis-on .cd-axis-line { display: block; }' +
        '#caChatDetail .bubble { font-size: 13px; }' +
        '#caChatDetail .bubble .msg-text { display: inline; }' +
        '#caChatDetail .row-received .bubble { padding-top: 7px; padding-bottom: 7px; }' +
        '#caChatDetail .row-received + .row-received { margin-top: 1px; }' +
        '#caChatDetail .row-sent + .row-sent { margin-top: 1px; }' +
        '#caChatDetail .row-sent .bubble { padding-top: 6.5px; padding-bottom: 6.5px; }' +
        '#caChatDetail .row-received + .row-received { margin-top: 2px; }' +
        ...
        '#caChatDetail .row-received .bubble { pointer-events: auto !important; position: relative; }' +
        '#caChatDetail .row-sent .bubble { pointer-events: auto !important; position: relative; }' +
        
        /* 翻译层完全穿透，不拦截任何触摸事件 */
        '#caChatDetail .expand-wrapper { pointer-events: none !important; }' +
        '#caChatDetail .expand-inner { pointer-events: none !important; }' +
        '#caChatDetail .trans-content, #caChatDetail .trans-block, #caChatDetail .trans-editorial { pointer-events: none !important; }' +
        '#caChatDetail .msg-text { pointer-events: none !important; }' +
...
function buildApiModalHTML() {
    ...
    '<div class="api-overlay" id="cdApiOverlay">' +
        '<div class="api-modal">' +
            '<div class="api-sig-wm" style="pointer-events:none;">Studio White</div>' +
